...
async function main(options) {
  ...
  await WRITERS.geojson(`dist/geojson/adresses-ouvertes-${departement}.geojson.gz`, adresses)
  await WRITERS.bal(`dist/bal/adresses-ouvertes-${departement}.csv.gz`, adresses)
  await WRITERS.ban(`dist/ban-v0/adresses-ouvertes-${departement}.csv.gz`, adresses)
}
